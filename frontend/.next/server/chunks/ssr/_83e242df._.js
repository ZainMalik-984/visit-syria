...
"[project]/app/[locale]/(auth)/login/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* app/(auth)/login/page.tsx – no localStorage, uses cookies */ __turbopack_context__.s({
    "default": (()=>LoginPage)
});
...
;
;
/* Tell axios to always send / receive cookies */ __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].defaults.withCredentials = true;
function LoginPage() {
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useTranslations"])('login'); // Namespace to 'login' in JSON
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const dispatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDispatch"])();
    const [phase, setPhase] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('login');
    ...
    /* ---------- login ---------- */ const handleLogin = async (e)=>{
        ...
        try {
            setLoading(true);
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/user/login/', {
                email,
                password
            });
            /* Inactive account → OTP step */ if (data.requires_verification) {
                setPhase('verify-otp');
                setInfo(data.message);
                return;
            }
            /* Active user → redux save + redirect
         Tokens are already in HttpOnly cookies – nothing to store */ dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginSuccess"])({
                role: data.user.role,
    ...
    /* ---------- OTP verify ---------- */ const handleVerify = async (e)=>{
        e.preventDefault();
        setError(null);
        setInfo(null);
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/user/verify-otp/', {
                email,
                otp
            });
            /* Auto-login immediately after OTP */ await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/user/login/', {
                email,
                password
            });
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginSuccess"])({
                role: 'customer',
                email
            })) // role isn’t in this response; adapt as needed
            ;
            router.replace('/dashboard');
        } catch (err) {
    ...
    const resendOTP = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/user/resend-otp/', {
            email
        }).then(()=>setInfo('OTP resent!'));
    /* ---------- UI (unchanged styling) ---------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        className: "min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-indigo-50 to-purple-50 dark:from-zinc-900 dark:via-zinc-950 dark:to-black px-4",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full max-w-lg space-y-8 rounded-2xl bg-white/80 dark:bg-zinc-800/75 backdrop-blur shadow-2xl ring-1 ring-zinc-200/60 dark:ring-zinc-700/60 p-8 animate-fadeIn",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mx-auto grid h-14 w-14 place-items-center rounded-full bg-indigo-600 text-white",
                ...
                phase === 'login' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    onSubmit: handleLogin,
                    className: "space-y-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            className: "text-center text-3xl font-extrabold text-indigo-600 dark:text-indigo-400",
                            children: t('title')
                        }, void 0, false, {
                            fileName: "[project]/app/[locale]/(auth)/login/page.tsx",
                            lineNumber: 92,
                ...
                phase === 'verify-otp' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    onSubmit: handleVerify,
                    className: "space-y-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "text-center text-2xl font-bold text-indigo-600 dark:text-indigo-400",
                ...
                error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Alert, {
                    color: "red",
                    children: error
                }, void 0, false, {
                    fileName: "[project]/app/[locale]/(auth)/login/page.tsx",
                ...
                info && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Alert, {
                    color: "green",
                    children: info
                }, void 0, false, {
                    fileName: "[project]/app/[locale]/(auth)/login/page.tsx",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-center text-xs text-zinc-600 dark:text-zinc-400",
                    children: [
                        t('noAccount'),
                        ' ',
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
/* --- helpers (unchanged) --- */ function Input(props) {
...
function Alert({ children, color }) {
    const style = color === 'red' ? 'border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20 text-red-600 dark:text-red-400' : 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/20 text-green-600 dark:text-green-400';
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `rounded-lg border p-3 text-center text-sm ${style}`,
        children: children
    }, void 0, false, {
        fileName: "[project]/app/[locale]/(auth)/login/page.tsx",
        lineNumber: 185,
...
//# sourceMappingURL=_83e242df._.js.map
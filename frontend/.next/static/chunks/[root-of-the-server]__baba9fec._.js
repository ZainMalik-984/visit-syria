...
const initialState = {
    isAuthenticated: ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('auth') === 'true' : ("TURBOPACK unreachable", undefined),
    role: ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('role') : ("TURBOPACK unreachable", undefined),
    email: null
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__baba9fec._.js.map
...
function SignUp() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/registeration/', {
    ...
    const handleVerify = async (e)=>{
        ...
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/verify-otp/', {
                email: form.email,
                otp
            });
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/login/', {
                email: form.email,
                password: form.password
            });
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginSuccess"])({
                role: form.role,
                email: form.email
            }));
    ...
    const resendOTP = async ()=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/resend-otp/', {
                email: form.email
            });
...
_s(SignUp, "3s0Whqnft2KGNOjKACb/EmBAouQ=", false, function() {
    return [
...
//# sourceMappingURL=_8086a0d3._.js.map
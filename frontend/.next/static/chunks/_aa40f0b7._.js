...
;
;
/* Tell axios to always send / receive cookies */ __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].defaults.withCredentials = true;
function LoginPage() {
    _s();
    ...
    /* ---------- login ---------- */ const handleLogin = async (e)=>{
        ...
        try {
            setLoading(true);
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/login/', {
                email,
                password
            });
         ...
         Tokens are already in HttpOnly cookies – nothing to store */ dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginSuccess"])({
                role: data.user.role,
    ...
    /* ---------- OTP verify ---------- */ const handleVerify = async (e)=>{
        ...
        try {
            ...
            /* Auto-login immediately after OTP */ await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/login/', {
                email,
                password
            });
    ...
    const resendOTP = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_lib$2f$axios$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/user/resend-otp/', {
            email
...
_s(LoginPage, "gqpnuoQThyaMcFEUeEoHVjyRzOg=", false, function() {
    return [
...
//# sourceMappingURL=_aa40f0b7._.js.map